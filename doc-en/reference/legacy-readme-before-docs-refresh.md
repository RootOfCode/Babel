...
See [doc-en/reference/primitives.md](primitives.md) for full parameter descriptions.
...
See [doc-en/reference/vocabulary.md](vocabulary.md) for signatures and patterns.
...
| Document | Contents |
|---|---|
| [doc-en/reference/primitives.md](primitives.md) | Every Layer-0 function with full parameter docs |
| [doc-en/reference/vocabulary.md](vocabulary.md) | How to read, write, and extend the vocabulary |
| [doc-en/reference/ai-system.md](ai-system.md) | Invention engine, scoring formula, evolution |
| [doc-en/reference/worlds.md](worlds.md) | Writing world programs, patterns, examples |
| [doc-en/reference/persistence.md](persistence.md) | Saving/loading, export formats, output dir |
