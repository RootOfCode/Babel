...
(defun print-banner ()
  ...
  (format t "  ║  SAVE    S=lib  W=OBJ  V=SVG  P=.world  F12=shot     ║~%")
  (format t "  ║  VOC     (save-vocabulary! p)  (load-vocabulary! p)  ║~%")
  (format t "  ║  OTHER   Z=undo  H=hud  ESC=quit                     ║~%")
  (format t "  ╠══════════════════════════════════════════════════════╣~%")
  (format t "  ║  START   (babel:initialize)                          ║~%")
  (format t "  ║          (babel:run-threaded)  ← opens window,       ║~%")
  (format t "  ║                                  keeps REPL free      ║~%")
  (format t "  ║          then: (babel:babel-eval (fortress 0 0 40))  ║~%")
  (format t "  ╚══════════════════════════════════════════════════════╝~%")
  (format t "~%"))
