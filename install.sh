...
echo ""
echo "  The SDL window opens with a clickable GUI overlay."
echo "  Use the left panel for scenes, display, generation, saves, and exports."
echo "  Press H for help or F2 to show/hide the GUI."
echo ""
echo "  The REPL remains available for optional live evaluation:"
